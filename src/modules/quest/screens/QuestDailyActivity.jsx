...
const Activity = ({
  ...
  const videoLinks = {
    S: "https://gitsagroup.com/s-closing-video",
    P: "https://gitsagroup.com/p-preapproach-video",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Image
                source={require("../../../../assets/quest/goal.png")}
                style={{
                  marginRight: 2,
                  width: 25,
                  height: 25,
            ...
            >
              <Image
                source={require("../../../../assets/quest/achieved.png")}
                style={{
                  marginRight: 4,
                  width: 20,
                  height: 20,
  ...
  useFocusEffect(
    React.useCallback(() => {
      if (token) {
        ...
        privateApi(token)
          .get(
            `/pas/monthly/app?date=${new Date().toLocaleDateString("en-GB")}`
          )
          .then((res) => {
        ...
        >
          ...
          >
            <Activity
              ...
              achieved={Math.ceil(entries?.weekly_achieved?.p_weekly) || 0}
              status={"P"}
              color={"#ff5757"}
              onPress={(value) =>
                updateAchievements({
