...
const QuestMyAgents = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <StatusBar barStyle="light-content" backgroundColor={"#3f8e9c"} />
              ...
              <View style={styles.agentContainer}>
                ...
                <View style={styles.actionRow}>
                  <TouchableOpacity
                    ...
                    onLongPress={() => openCoachingModal(agentId, item.fullName)}
                  >
                    {isLoading ? (
